...
var identifierRe = /[^#\s"][^\s\[({\])}]*/;

var RacketHighlightRules = function(options) {
    var keywordMapper = this.createKeywordMapper({
        "constant.language.boolean": "true|false",
        "keyword": "check-expect|define|define-struct",
...
var RacketHighlightRules = require("./racket_highlight_rules").RacketHighlightRules;
var MatchingBraceOutdent = require("./matching_brace_outdent").MatchingBraceOutdent;
var CstyleBehaviour = require("./behaviour/racket").CstyleBehaviour;
...
(function() {
    ...
    this.getNextLineIndent = function(state, line, tab) {
        ...
        let opens = [];
        var extra = 0; // if extra, need to look backwards for opening brackets
